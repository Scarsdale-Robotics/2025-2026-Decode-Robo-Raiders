...
import org.firstinspires.ftc.teamcode.opmodes.testing.TeleOpBlue.Companion.ofsTurret
...
//        Gamepads.gamepad2.cross whenBecomesFalse PusherServoSubsystem.out
        ...
        Gamepads.gamepad2.square whenBecomesTrue {
            odom!!.setPinpoint(
                resetPosX, resetPosY, resetPosH
            )
            gamepad1.rumble(500)
            gamepad2.rumble(500)
        }
        Gamepads.gamepad2.triangle whenBecomesTrue {
            TurretPhiSubsystem.reset()
            ofsTurret = 0.0
        }
...
//        }
        ...
        ofsTurret += gamepad2.left_stick_x * 20.0
