...
//        var directionGoalY = 144.0-4.0;
    ...
    private val startPose =
        Pose(144 - 56.43, 8.503, Math.toRadians(0.0)) // Start Pose of our robot.
    private val shootPoseClose =
        Pose(
            144 - 57.0,
            76.6,
            Math.toRadians(blueRedConvertAngle(128.0))
        ) // Close Shoot Pose of our robot.
    private val shootPoseFar =
        Pose(
            144 - 57.0,
            13.5,
            Math.toRadians(blueRedConvertAngle(120.0))
        ) // Far Shoot Pose of our robot.
    private val gateOpenPose =
        Pose(
            144 - 14.0,
            60.0,
            Math.toRadians(blueRedConvertAngle(145.0))
        ) // Gate Open Pose of our robot.
