...
//    val startPoseClose = Pose(17.1887, 115.3623, Math.toRadians(270.0))
    ...
    val intake2Pos24 = Pose(19.6, 60.9, Math.toRadians(180.0))
    val intake2P24CPos = Pose(45.2, 63.3)
    ...
    val commonIntakeControlPos24 = Pose(33.1, 13.2) //was (54.8, 36.7)
...
//    val CoOpCommonIntakeControlPos2 = Pose(82.0, 32.0)
    ...
    val shootPoseCloseAlt =
        Pose(57.9, 78.0, Math.toRadians(210.0)) // Close Shoot Pose of our robot.
    val shootPoseFar =
    ...
    val gateOpenPoseTele =
        Pose(15.2, 56.2, Math.toRadians(150.0)) // Gate Open Pose of our robot.
    val gateOpenPrePoseTele =
        Pose(22.0, 56.2, Math.toRadians(150.0)) // Gate Open Pose of our robot.
