...
class AutonBlueCloseCoOp : AutonBase(
    ...
    { isBlue, follower -> {
        ...
        val setLine2Pose = Pos(Pose(19.5, 64.0), isBlue)
        ...
        val gateIntakePose = Pos(Pose(14.7266, 62.7943), isBlue)
        ...
        val setLine1Pose = Pos(Pose(19.5, 87.0), isBlue)
